...
import { ExperienceDTO, EducationDTO, ProjectDTO, SkillDTO, ReferenceDTO } from "../../types/profile";
        ...
        {profile.experiences.length === 0 ? (
          ...
          profile.experiences.map((exp) => (
            <Card 
              ...
              title={<span className="text-white font-semibold">{exp.company || "New Experience"}</span>}
              extra={
                <Button 
                  type="text" 
                  danger 
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <Button 
                  ...
                  onClick={() => {
                    const newBullet = {
                      id: "", // Will be generated on server or created on save
        ...
        {profile.education.length === 0 ? (
          ...
          profile.education.map((edu) => (
            <Card 
              key={edu.id} 
              className="bg-zinc-900/50 border-zinc-800 text-white"
              title={<span className="text-white font-semibold">{edu.institution || "New Institution"}</span>}
              extra={
                <Button 
                  type="text" 
                  danger 
        ...
        {profile.projects.length === 0 ? (
          ...
          profile.projects.map((proj) => (
            <Card 
              key={proj.id} 
              className="bg-zinc-900/50 border-zinc-800 text-white"
              title={<span className="text-white font-semibold">{proj.name || "New Project"}</span>}
              extra={
                <Button 
                  type="text" 
                  danger 
