...
2. **Create the Application Directory**:
   ...
   - Sanitize these names to create a directory path: `/Users/wagnertaiatella/repos/myJobs/applications/<company-name>-<job-title>/`.

3. **Save the Job Description**:
   - Save a structured job description markdown file to `/Users/wagnertaiatella/repos/myJobs/applications/<company-name>-<job-title>/job_description.md`.
...
4. **Calculate Potential Score**:
   - Read the user's scoring criteria in `/Users/wagnertaiatella/repos/myJobs/skills/analyze_job/preferences.md`.
   ...
   - Save this evaluation in English to `/Users/wagnertaiatella/repos/myJobs/applications/<company-name>-<job-title>/analysis.md`.

5. **Update Main Dashboard**:
   - Open `/Users/wagnertaiatella/repos/myJobs/README.md`.
